...
class SAPI
{
	...
	public function __construct($data = FALSE)
	{
		if (is_array($data))
		{
			...
			$this->setup([
				'API_KEY' => Property::env('EnvShopifyApiKey'), 
				'API_SECRET' => Property::env('EnvShopifyApiSecret'), 
				'SHOP_DOMAIN' => Property::env('EnvShopifyShopDomain'), 
				'ACCESS_TOKEN' => Property::env('EnvShopifyAccessToken')
			]);
		}
	}
